...
Sub Class_Globals
	...
	Public ScanPage As B4XPageScan
	Public CountPage As B4XPageCount
	Public VariancePage As B4XPageVariance
	Public HistoryPage As B4XPageHistory
...
Sub ShowSplashScreen As ResumableSub
	...
	ScanPage.Initialize
	CountPage.Initialize
	VariancePage.Initialize
	HistoryPage.Initialize
	SettingsPage.Initialize

	B4XPages.AddPage("login", LoginPage)
	B4XPages.AddPage("dashboard", DashboardPage)
	B4XPages.AddPage("scan", ScanPage)
	B4XPages.AddPage("count", CountPage)
	B4XPages.AddPage("variance", VariancePage)
	B4XPages.AddPage("history", HistoryPage)
...
Private Sub B4XPage_CloseRequest As ResumableSub
	Dim sf As Object = ShowSwalConfirm("Close Demo StockTake?", "Are you sure you want to close the application?", "Yes", "No")
