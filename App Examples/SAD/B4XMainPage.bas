...
Sub Class_Globals
	...
	' Page instances (only the pages in the SAD demo)
...
Private Sub B4XPage_Created (Root1 As B4XView)
	...
	'Show login as the app start page (SAD is login-gated).
...
Private Sub B4XPage_CloseRequest As ResumableSub
	Dim sf As Object = ShowSwalConfirm("Close SAD?", "Are you sure you want to close the application?", "Yes", "No")
