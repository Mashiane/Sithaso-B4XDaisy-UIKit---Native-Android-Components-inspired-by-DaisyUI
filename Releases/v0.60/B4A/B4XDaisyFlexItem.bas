...
'Fluent helper for configuring one flex item inside B4XDaisyFlexPanel

#IgnoreWarnings:12
Sub Class_Globals
    Private mOwner As B4XDaisyFlexPanel
...
Public Sub Initialize(Owner As B4XDaisyFlexPanel, v As B4XView)
    mOwner = Owner
    mView = v
End Sub

Public Sub Reset As B4XDaisyFlexItem
    pGrow = 0
    pShrink = 1
...
Public Sub Grow(Value As Float) As B4XDaisyFlexItem
    pGrow = Value
    hasFlex = True
    Return Me
End Sub

Public Sub Shrink(Value As Float) As B4XDaisyFlexItem
    pShrink = Value
    hasFlex = True
    Return Me
End Sub

Public Sub Flex(GrowValue As Float, ShrinkValue As Float) As B4XDaisyFlexItem
    pGrow = GrowValue
    pShrink = ShrinkValue
    hasFlex = True
    Return Me
...
' TailwindCSS: flex-1 (grow:1, shrink:1, basis:0%)
Public Sub Flex1 As B4XDaisyFlexItem
    pGrow = 1
    pShrink = 1
    hasFlex = True
    pBasisW = 0
...
' TailwindCSS: flex-auto (grow:1, shrink:1, basis:auto)
Public Sub FlexAuto As B4XDaisyFlexItem
    pGrow = 1
    pShrink = 1
    hasFlex = True
    pBasisW = -1
...
' TailwindCSS: flex-initial (grow:0, shrink:1, basis:auto)
Public Sub FlexInitial As B4XDaisyFlexItem
    pGrow = 0
    pShrink = 1
    hasFlex = True
    pBasisW = -1
...
' TailwindCSS: flex-none (grow:0, shrink:0)
Public Sub FlexNone As B4XDaisyFlexItem
    pGrow = 0
    pShrink = 0
    hasFlex = True
    Return Me
...
Public Sub MinW(Value As Int) As B4XDaisyFlexItem
    pMinW = Value
    hasFlex = True
    Return Me
End Sub

Public Sub MaxW(Value As Int) As B4XDaisyFlexItem
    pMaxW = Value
    hasFlex = True
    Return Me
End Sub

Public Sub MinH(Value As Int) As B4XDaisyFlexItem
    pMinH = Value
    hasFlex = True
    Return Me
End Sub

Public Sub MaxH(Value As Int) As B4XDaisyFlexItem
    pMaxH = Value
    hasFlex = True
    Return Me
End Sub

Public Sub MinSize(W As Int, H As Int) As B4XDaisyFlexItem
    pMinW = W
    pMinH = H
    hasFlex = True
    Return Me
...
Public Sub MaxSize(W As Int, H As Int) As B4XDaisyFlexItem
    pMaxW = W
    pMaxH = H
    hasFlex = True
    Return Me
...
Public Sub Basis(W As Int, H As Int) As B4XDaisyFlexItem
    pBasisW = W
    pBasisH = H
    hasBasis = True
    Return Me
...
Public Sub BasisPercent(MainPct As Float, CrossPct As Float) As B4XDaisyFlexItem
...
Public Sub Margins(Left As Int, Top As Int, Right As Int, Bottom As Int) As B4XDaisyFlexItem
    pML = Left : pMT = Top : pMR = Right : pMB = Bottom
    hasMargins = True
    Return Me
End Sub

Public Sub MarginAll(Value As Int) As B4XDaisyFlexItem
    pML = Value : pMT = Value : pMR = Value : pMB = Value
    hasMargins = True
    Return Me
End Sub

Public Sub MarginX(Value As Int) As B4XDaisyFlexItem
    pML = Value : pMR = Value
    hasMargins = True
    Return Me
End Sub

Public Sub MarginY(Value As Int) As B4XDaisyFlexItem
    pMT = Value : pMB = Value
    hasMargins = True
    Return Me
End Sub

Public Sub AlignSelf(Value As String) As B4XDaisyFlexItem
    pAlignSelf = Value
    hasAlignSelf = True
    Return Me
End Sub

Public Sub Order(Value As Int) As B4XDaisyFlexItem
    pOrder = Value
    hasOrder = True
    Return Me
End Sub

Public Sub WrapBefore(Value As Boolean) As B4XDaisyFlexItem
    pWrapBefore = Value
    hasWrapBefore = True
    Return Me
End Sub
...
Public Sub Apply As B4XDaisyFlexItem
...
Public Sub ApplyNoRelayout As B4XDaisyFlexItem
    If mOwner.IsInitialized = False Then Return Me
    If mView.IsInitialized = False Then Return Me
...
Public Sub ApplyEx(DoRelayout As Boolean) As B4XDaisyFlexItem
    If DoRelayout Then
        Return Apply
    Else
