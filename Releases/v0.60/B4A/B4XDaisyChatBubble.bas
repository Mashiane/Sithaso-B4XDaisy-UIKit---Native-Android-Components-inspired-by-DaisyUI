...
Private Sub ApplyDesignerProps(Props As Map)
	...
	mAvatarMask = B4XDaisyVariants.NormalizeMask(B4XDaisyVariants.GetPropString(Props, "AvatarMask", "squircle"))
	mAvatarSize = Max(16dip, B4XDaisyVariants.GetPropDip(Props, "AvatarSize", 40))
	setSide(B4XDaisyVariants.GetPropString(Props, "Side", "start"))
	setBubbleStyle(B4XDaisyVariants.GetPropString(Props, "BubbleStyle", "rounded"))
	...
	mUseFromToColors = B4XDaisyVariants.GetPropBool(Props, "UseFromToColors", False)
	mFromBackgroundColor = B4XDaisyVariants.GetPropInt(Props, "FromBackgroundColor", 0xFFE5E7EB)
	mFromTextColor = B4XDaisyVariants.GetPropInt(Props, "FromTextColor", 0xFF111827)
	mToBackgroundColor = B4XDaisyVariants.GetPropInt(Props, "ToBackgroundColor", 0xFFDBEAFE)
	mToTextColor = B4XDaisyVariants.GetPropInt(Props, "ToTextColor", 0xFF1E3A8A)
	...
	setVariant(B4XDaisyVariants.GetPropString(Props, "Variant", "neutral"))
End Sub
