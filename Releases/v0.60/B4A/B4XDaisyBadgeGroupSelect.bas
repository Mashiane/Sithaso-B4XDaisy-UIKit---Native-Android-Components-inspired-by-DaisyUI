...
Private Sub ApplyDesignerProps(Props As Map)
	...
	mcBackgroundColor = B4XDaisyVariants.GetPropColor(Props, "BackgroundColor", 0x00000000)
	mcTextColor = B4XDaisyVariants.GetPropColor(Props, "TextColor", 0x00000000)
	mcBorderColor = B4XDaisyVariants.GetPropColor(Props, "BorderColor", 0x00000000)
	miBorderSize = B4XDaisyVariants.GetPropInt(Props, "BorderSize", 1)

	msBadgeSelectionMode = B4XDaisyVariants.NormalizeSelectionMode(B4XDaisyVariants.GetPropString(Props, "BadgeSelectionMode", "multi"))
	...
	mcBadgeCheckedColor = B4XDaisyVariants.GetPropColor(Props, "BadgeCheckedColor", 0)
	mcBadgeCheckedTextColor = B4XDaisyVariants.GetPropColor(Props, "BadgeCheckedTextColor", 0)
