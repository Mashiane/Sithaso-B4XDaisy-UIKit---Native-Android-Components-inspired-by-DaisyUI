...
Private Sub EnsureShadowVisibility
    ...
    B4XDaisyVariants.DisableClippingChain(pnlSurface, 1)
    B4XDaisyVariants.DisableClippingChain(pnlLegendMask, 1)
End Sub
...
Public Sub AddToParent(Parent As B4XView, Left As Int, Top As Int, Width As Int, Height As Int) As B4XView
    If mBase.IsInitialized = False Then
        ...
        DesignerCreateView(p, Null, CreateMap( _
            "Legend": msLegend, _
            "Variant": msVariant, _
            "LegendSize": msLegendSize, _
            "BorderStyle": msBorderStyle, _
            "Padding": miPaddingDip / 1dip, _
            ...
            "BorderColor": mcBorderColor, _
            "BorderSize": miBorderSize / 1dip _
        ))
    End If
    B4XDaisyVariants.DisableClippingChain(Parent, 3)
    Return mBase
End Sub
