...
B4XDaisyVariants.DisableClipping(parent)
    B4XDaisyVariants.DisableClipping(mTarget)
    B4XDaisyVariants.DisableClipping(mBase)
    B4XDaisyVariants.DisableClipping(Surface)
...
Private Sub ResolveRoundedMode As String
	...
	Return B4XDaisyVariants.NormalizeRounded(mRounded)
End Sub
...
Private Sub ApplyDesignerProps(Props As Map)
	mHorizontalPlacement = B4XDaisyVariants.NormalizeHorizontalPlacement(B4XDaisyVariants.GetPropString(Props, "HorizontalPlacement", "end"))
	mVerticalPlacement = B4XDaisyVariants.NormalizeVerticalPlacement(B4XDaisyVariants.GetPropString(Props, "VerticalPlacement", "top"))
	mOffsetX = B4XDaisyVariants.GetPropSizeDip(Props, "OffsetX", "0")
	mOffsetY = B4XDaisyVariants.GetPropSizeDip(Props, "OffsetY", "0")
	mText = B4XDaisyVariants.GetPropString(Props, "Text", "")
	mCounter = B4XDaisyVariants.GetPropBool(Props, "Counter", False)
	mVariant = B4XDaisyVariants.NormalizeVariant(B4XDaisyVariants.GetPropString(Props, "Variant", "none"))
	mSize = B4XDaisyVariants.NormalizeSize(B4XDaisyVariants.GetPropString(Props, "Size", "sm"))
	mIconAsset = B4XDaisyVariants.GetPropString(Props, "IconAsset", "").Trim
	mRounded = B4XDaisyVariants.NormalizeRounded(B4XDaisyVariants.GetPropString(Props, "Rounded", "rounded"))
...
Public Sub setHorizontalPlacement(Value As String)
	mHorizontalPlacement = B4XDaisyVariants.NormalizeHorizontalPlacement(Value)
	If mBase.IsInitialized = False Then Return
	RefreshPlacement
End Sub
...
Public Sub setVerticalPlacement(Value As String)
	mVerticalPlacement = B4XDaisyVariants.NormalizeVerticalPlacement(Value)
	If mBase.IsInitialized = False Then Return
	RefreshPlacement
End Sub
