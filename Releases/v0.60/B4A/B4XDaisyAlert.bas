...
Private Sub ApplyDesignerProps(Props As Map)
	...
	mVariant = B4XDaisyVariants.NormalizeAlertVariant(B4XDaisyVariants.GetPropString(Props, "Variant", "none"))
	mStyle = B4XDaisyVariants.NormalizeStyle(B4XDaisyVariants.GetPropString(Props, "AlertStyle", "solid"))
	mDirection = B4XDaisyVariants.NormalizeDirection(B4XDaisyVariants.GetPropString(Props, "Direction", "horizontal"))
	mTitle = B4XDaisyVariants.GetPropString(Props, "Title", "")
	mText = B4XDaisyVariants.GetPropString(Props, "Text", "12 unread messages. Tap to see.")
	mDescription = B4XDaisyVariants.GetPropString(Props, "Description", "")
