...
Private Sub ApplyDesignerProps(Props As Map)
	...
	mAnimation = B4XDaisyVariants.NormalizeAnimation(B4XDaisyVariants.GetPropString(Props, "Animation", "none"))
	mPadding = B4XDaisyVariants.GetPropString(Props, "Padding", "")
	mMargin = B4XDaisyVariants.GetPropString(Props, "Margin", "1")
...
Private Sub LayoutShadow(Side As Int, DotLeft As Int, DotTop As Int, BackColor As Int)
	...
	Dim softColor As Int = B4XDaisyVariants.AlphaColor(B4XDaisyVariants.Blend(BackColor, xui.Color_Black, 0.15), alpha01)
...
Private Sub LayoutRing(Side As Int, BackColor As Int)
	...
	Dim ringColor As Int = B4XDaisyVariants.AlphaColor(B4XDaisyVariants.Blend(BackColor, xui.Color_White, 0.35), 0.45)
...
Private Sub LayoutHighlight(Side As Int)
	...
	HighlightHost.SetColorAndBorder(B4XDaisyVariants.AlphaColor(xui.Color_White, alpha01), 0dip, xui.Color_Transparent, glowSize / 2)
End Sub
...
Private Sub ResolveVisualColors As Map
	...
	Dim defaultBack As Int = B4XDaisyVariants.AlphaColor(baseContent, 0.2)
	Dim defaultText As Int = B4XDaisyVariants.AlphaColor(xui.Color_Black, 0.3)
...
Public Sub setAnimation(Value As String)
	mAnimation = B4XDaisyVariants.NormalizeAnimation(Value)
	If mBase.IsInitialized = False Then Return
	UpdateAnimationState
End Sub
