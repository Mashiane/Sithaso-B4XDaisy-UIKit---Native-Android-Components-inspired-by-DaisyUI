...
Private Sub B4XPage_CloseRequest As ResumableSub
	Dim sf As Object = B4XPages.MainPage.ShowSwalConfirm("Close B4XDaisyUIKit?", "Are you sure you want to close the application?", "Yes", "No")
...
Private Sub PopulateDashboard
	...
	Dashboard.AddItem("easing", "Easing Interpolator", "canvasspinner.jpeg")
	...
	Dashboard.AddItem("shinebutton", "Shine Button", "heart-solid.svg")
	...
	Dashboard.AddItem("sweetalertinputs", "Sweet Alert Inputs", "alert.webp")
